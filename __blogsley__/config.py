...
# Set Globals
pip_share_folder = os.path.join(sys.prefix, 'share/blogsley-jam')
is_pip_install = os.path.isdir(pip_share_folder)

if is_pip_install:
    share_folder = pip_share_folder
else:
    share_folder = os.path.abspath(os.path.join(os.path.dirname(__file__), '../share/blogsley-jam'))


project_share_folder = 'share/blogsley-jam'
